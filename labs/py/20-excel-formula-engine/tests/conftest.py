...
def pytest_configure(config):
    ...
    path = ROOT / which / "excel_engine.py"
    spec = importlib.util.spec_from_file_location("excel_engine", path)
    mod = importlib.util.module_from_spec(spec)
    sys.modules["excel_engine"] = mod
...
@pytest.fixture
def E():
    return sys.modules["excel_engine"]

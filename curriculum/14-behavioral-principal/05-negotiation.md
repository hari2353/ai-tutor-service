...
### Q6 — Should you ever accept a counteroffer from your current employer after resigning to take another job?
**Testing:** whether the candidate understands the well-documented, usually-bad dynamics of counteroffers, not just "more money is good."
**Answer:** Usually no, and the reasoning matters more than the rule: a counteroffer typically addresses only the comp gap that made you look elsewhere, not the underlying reasons (scope, growth ceiling, management, team) that made you start interviewing in the first place — those tend to resurface within 6-12 months. There's also a trust cost that's easy to underweight: having demonstrated you were prepared to leave, many managers quietly start planning your replacement or deprioritizing you for the next stretch role, even after a counteroffer is accepted, because the relationship's implicit trust took real damage. The exception is narrow: the counter comes with a genuine, structural fix to the actual reason you were leaving (a real scope change, a role change, not just a number), not just a matched salary.
**Follow-up trap:** *"Your manager says the comp gap WAS the actual reason, and they're matching it exactly. Isn't that a clean case for staying?"* — probe whether the money was suddenly available because you were about to leave, which is itself informative: if the company could pay this the whole time and didn't until you threatened to leave, that's a data point about how compensation gets set there going forward, not just a one-time fix — ask directly whether this changes your baseline comp trajectory or is a one-time retention exception.

### Q7 — As a staff/principal engineer, a report on your team shows you a lowball offer from another company and asks for advice before responding. What do you tell them, and what do you deliberately not do?
**Testing:** whether the candidate can operate as a negotiation coach, not just a personal negotiator — a real principal-level skill this module's framing implies but doesn't test directly elsewhere.
**Answer:** Walk them through the same mechanics this module covers — check the vesting schedule and discount any private equity explicitly, compare against real levels.fyi/Blind data for their specific level, and help them draft a specific, professional counter rather than a vague "ask for more." What to deliberately not do: don't use your own internal knowledge of the *other* company's band (if you have it from a prior role or industry contacts) in a way that could be traced back to you as a source, and don't offer to counter-negotiate on their behalf or contact the recruiter directly — it's their negotiation, and your job is calibration and confidence, not doing it for them.
**Follow-up trap:** *"They ask you directly what your own team's band is for their level, since you clearly have access to it, to use as a comparison point."* — this is a real judgment call with a company-policy dimension: many companies explicitly permit sharing banded ranges with reports (especially post-SB-1162-era transparency norms) but not exact individual figures — share what you're authorized to share, and if genuinely unsure, say so explicitly rather than guessing at the boundary, since getting this wrong has real trust and policy consequences beyond the negotiation itself.

### Q8 — How does negotiating an internal promotion-driven comp increase differ mechanically from negotiating a new external offer?
**Testing:** whether the candidate recognizes internal negotiation has a different leverage structure entirely, not just a smaller version of the same conversation.
**Answer:** External negotiation leverage comes from a competing offer or credible walk-away; internal promotion comp is instead bounded by your company's own leveling bands and merit-increase budget cycle, which are usually fixed at specific times of year (annual review cycles, promotion committee calendars) rather than negotiable in the moment the way an offer conversation is. The actual lever internally is building the promotion case itself (the calibration and evidence covered in `T14-principal-competencies`) well before the comp conversation, since the comp increase mostly follows automatically once the level change is approved — negotiating the number in isolation, without the level change, usually has much less room than negotiating an external offer does.
**Follow-up trap:** *"Your promotion was approved but the comp increase feels low relative to what a new-hire at the same level would get."* — this is a real, common phenomenon (new-hire offers are calibrated against external market competition; internal promotions are often calibrated against internal equity and budget cycles, and the two aren't reliably reconciled) — the honest move is naming the specific gap with data (what a comparable new hire at your new level is getting, per levels.fyi) directly to your manager as a retention-risk conversation, since "internal promotions pay less than external hires at the same level" is a known industry pattern significant enough to be worth surfacing explicitly rather than quietly accepting.

### Q9 — Research on first-offer anchoring (Galinsky & Mussweiler) finds a meta-analytic correlation of roughly 0.497 between the first number stated in a negotiation and the final outcome. If anchoring is genuinely this powerful, why does "never give a number first" sometimes backfire?
**Testing:** whether the candidate understands anchoring isn't unconditionally in your favor just because you deflected.
**Answer:** The anchoring research also finds the effect is substantially reduced when the other party actively counters it — deliberately focusing on their own reservation price, their alternatives, or a specific target number rather than passively accepting the anchor. Practically: refusing to name a number only helps if you *also* do the work of arriving at and anchoring on your own real number once forced to, or countering their anchor immediately and specifically rather than accepting it as the frame — silently deflecting and then accepting whatever number follows without an explicit counter-anchor gets you the worst of both: no anchoring advantage of your own, and no protection from theirs either.
**Follow-up trap:** *"So is it ever correct to give a number first?"* — yes, specifically when you have strong, well-researched market data and reasonable confidence the number you'd state is at or above what they were prepared to offer — in that specific case, anchoring high yourself can outperform deflecting, since the .497 correlation cuts both ways; deflection is the safer default specifically because most candidates don't have strong enough data to be confident their anchor beats the company's, not because giving a number first is unconditionally wrong.

### Q10 — You're negotiating in a market downturn where competing offers are scarce industry-wide, unlike the parallel-process leverage this module assumes as the default. What changes about your approach?
**Testing:** whether the candidate can adapt the framework rather than treating it as fixed rules independent of market conditions.
**Answer:** With competing-offer leverage scarce, shift weight toward the lower-friction levers that don't require a hard alternative to justify (sign-on bonus, start date, equity refresh terms) since those are grantable on their own merits regardless of your visible leverage, and lean harder on market-data anchoring (levels.fyi/Blind) rather than a walk-away posture that's less credible when everyone knows the market is tight. It's also honest to recognize the realistic ceiling is lower in a down market — the framework's mechanics (check vesting, discount private equity, negotiate the whole package once) still apply, but the size of the ask that's reasonable to make shrinks, and pushing as if conditions were the same as a hot market reads as out of touch rather than confident.
**Follow-up trap:** *"Doesn't 'read the market and ask for less' just mean you should always negotiate less aggressively, defeating the point of this module?"* — no — the mechanics (don't anchor yourself, check the full package, don't accept the first number reflexively) hold in any market, because they're about not leaving money on the table relative to what's actually available, not about extracting a fixed amount regardless of conditions; a down-market negotiation done well still typically beats not negotiating at all, even if the ceiling is lower than a hot-market negotiation would produce.
...
- [levels.fyi](https://www.levels.fyi/) — verified tech compensation by company and level (reference standard for comp data) — accessed 2026-08-08
- [Blind](https://www.teamblind.com/) — anonymous, verified-employee discussion of compensation and negotiation — accessed 2026-08-08
- [California Pay Transparency Law Requirements — SB 1162 overview](https://www.sixfifty.com/blog/california-pay-transparency-law-requirements/) — accessed 2026-08-08
- [First Offers as Anchors: The Role of Perspective-Taking and Negotiator Focus — Galinsky & Mussweiler, Journal of Personality and Social Psychology, 2001 (PubMed)](https://pubmed.ncbi.nlm.nih.gov/11642352/) — accessed 2026-08-08
- [First offers in negotiations: Determinants and effects — Columbia Business School (meta-analytic ~0.497 correlation between first offer and final outcome)](https://business.columbia.edu/sites/default/files-efs/pubfiles/11691/first_offers.pdf) — accessed 2026-08-08

Note: current hiring-market temperature (competing-offer frequency, comp trends for senior/staff/principal AI roles specifically) is time-sensitive and should be verified against levels.fyi/Blind at the time of an actual negotiation rather than assumed from this module; the sources above are structurally stable (legal requirements, published research) rather than point-in-time market data.
